...
const getJsonForUnwind = (path, preserveNullAndEmptyArrays) => {
  ...
  json[dbOpration.FIELD_PRESERVE_NULL_AND_EMPTY_ARRAYS] =
    preserveNullAndEmptyArrays; // null, missing, or an empty array mean get all the obj
  return json;
};
...
const getUpdateJsonFormat = (updateJson) => {
  let json = {};
  json[dbOpration.OP_SET] = updateJson;
  return json;
};
